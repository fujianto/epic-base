...
add_action( 'after_setup_theme', 'epic_base_custom_background_setup', 15 );
 ...
 * @return void
 */
function epic_base_custom_background_setup() {
 ...
 * @return void
 */
function epic_base_custom_background_callback() {
