...
function epic_base_custom_header_setup() {
	...
	add_theme_support( 
		...
		array(
			...
			'admin-head-callback'    => 'epic_base_custom_header_admin_head',
			'admin-preview-callback' => 'epic_base_custom_header_admin_preview',
		)
	);
 ...
 * @return void
 */
function epic_base_custom_header_admin_preview() { ?>
 ...
 * @return void
 */
function epic_base_custom_header_admin_head() {
