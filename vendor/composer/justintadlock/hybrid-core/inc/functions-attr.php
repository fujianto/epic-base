...
function hybrid_attr_sidebar( $attr, $context ) {
	...
	if ( $context ) {
		...
		if ( $sidebar_name ) {
			...
			$attr['aria-label'] = esc_attr( sprintf( _x( '%s Sidebar', 'sidebar aria label', 'epic-base' ), $sidebar_name ) );
		}
	}
...
function hybrid_attr_menu( $attr, $context ) {
	...
	if ( $context ) {
		...
		if ( $menu_name ) {
			...
			$attr['aria-label'] = esc_attr( sprintf( _x( '%s Menu', 'nav menu aria label', 'epic-base' ), $menu_name ) );
		}
	}
...
function hybrid_attr_entry_published( $attr ) {
	...
	$attr['title']    = get_the_time( _x( 'l, F j, Y, g:i a', 'post time format', 'epic-base' ) );
...
function hybrid_attr_comment_published( $attr ) {
	...
	$attr['title']    = get_comment_time( _x( 'l, F j, Y, g:i a', 'comment time format', 'epic-base' ) );
	$attr['itemprop'] = 'datePublished';
