...
function hybrid_attr_sidebar( $attr, $context ) {
	...
	if ( $context ) {
		...
		if ( $sidebar_name ) {
			...
			$attr['aria-label'] = esc_attr( sprintf( esc_html_x( '%s Sidebar', 'sidebar aria label', 'hybrid-core' ), $sidebar_name ) );
		}
	}
...
function hybrid_attr_menu( $attr, $context ) {
	...
	if ( $context ) {
		...
		if ( $menu_name ) {
			...
			$attr['aria-label'] = esc_attr( sprintf( esc_html_x( '%s Menu', 'nav menu aria label', 'hybrid-core' ), $menu_name ) );
		}
	}
...
function hybrid_attr_entry_published( $attr ) {
	...
	$attr['title']    = get_the_time( esc_html_x( 'l, F j, Y, g:i a', 'post time format', 'hybrid-core' ) );
...
function hybrid_attr_comment_published( $attr ) {
	...
	$attr['title']    = get_comment_time( esc_html_x( 'l, F j, Y, g:i a', 'comment time format', 'hybrid-core' ) );
	$attr['itemprop'] = 'datePublished';
