...
function hybrid_get_wp_link() {
	return sprintf( '<a class="wp-link" href="%s">%s</a>', esc_url( __( 'http://wordpress.org', 'epic-base' ) ), esc_html__( 'WordPress', 'epic-base' ) );
}
...
function hybrid_get_single_archive_title() {
	return esc_html__( 'Archives', 'epic-base' );
}
...
function hybrid_get_single_year_title() {
	return get_the_date( esc_html_x( 'Y', 'yearly archives date format', 'epic-base' ) );
}
...
function hybrid_get_single_week_title() {
	...
	return sprintf( esc_html__( 'Week %1$s of %2$s', 'epic-base' ), get_the_time( esc_html_x( 'W', 'weekly archives date format', 'epic-base' ) ), get_the_time( esc_html_x( 'Y', 'yearly archives date format', 'epic-base' ) ) );
}
...
function hybrid_get_single_day_title() {
	return get_the_date( esc_html_x( 'F j, Y', 'daily archives date format', 'epic-base' ) );
}
...
function hybrid_get_single_hour_title() {
	return get_the_time( esc_html_x( 'g a', 'hour archives time format', 'epic-base' ) );
}
...
function hybrid_get_single_minute_title() {
	...
	return sprintf( esc_html__( 'Minute %s', 'epic-base' ), get_the_time( esc_html_x( 'i', 'minute archives time format', 'epic-base' ) ) );
}
...
function hybrid_get_single_minute_hour_title() {
	return get_the_time( esc_html_x( 'g:i a', 'minute and hour archives time format', 'epic-base' ) );
}
...
function hybrid_get_search_title() {
	...
	return sprintf( esc_html__( 'Search results for &#8220;%s&#8221;', 'epic-base' ), get_search_query() );
}
...
function hybrid_get_404_title() {
	return esc_html__( '404 Not Found', 'epic-base' );
}
